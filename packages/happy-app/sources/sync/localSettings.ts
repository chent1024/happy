...
export const LocalSettingsSchema = z.object({
    ...
    voiceUpsellOverride: z.enum(['control', 'show-paywall-before-first-voice-chat', 'voice-onboarding-and-upsell']).nullable().describe('Developer-only local override for the voice-upsell variant'),
    ...
    qwenTtsMachineId: z.string().nullable().describe('Paired Happy machine used by Android Qwen narration'),
