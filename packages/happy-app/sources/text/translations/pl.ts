...
export const pl: TranslationStructure = {
    ...
    status: {
        ...
        recentlyActive: ({ time }: { time: string }) => `Recently active ${time}`,
    ...
    sessionInfo: {
        ...
        continueCodexSession: 'Kontynuuj',
        ...
        restartSessionConfirmTitle: 'Restart session?',
        restartSessionConfirmMessage: 'This keeps the current thread and messages, stops the local session process, then starts it again on the same machine.',
        restartSessionConfirmAction: 'Restart',
    ...
    codex: {
        ...
        sync: {
            accessibilityLabel: 'Sync latest Codex sessions',
            title: 'Sync Codex sessions',
            manual: 'Manual',
            subtitle: 'Import recent local Codex.app thread metadata for this machine.',
            footer: 'Recent non-archived threads only',
            syncing: 'Syncing',
            ready: 'Ready',
            offline: 'Offline',
