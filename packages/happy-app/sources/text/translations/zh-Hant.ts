...
export const zhHant: TranslationStructure = {
    ...
    status: {
        ...
        recentlyActive: ({ time }: { time: string }) => `最近活躍 ${time}`,
    ...
    sessionInfo: {
        ...
        resumeSessionNeedsHappyAgent: '此裝置暫不支援恢復。請執行 `happy-agent auth login` 啟用。',
        resumeSessionMissingMachine: '此工作階段缺少裝置中繼資料，無法恢復。',
        resumeSessionMissingBackendId: '此工作階段沒有可恢復的 Claude 或 Codex 標識。',
        resumeSessionUnexpectedDirectoryPrompt: '恢復流程不能建立目錄。請從原始路徑手動啟動工作階段。',
        restartSession: '重啟工作階段',
        restartSessionConfirmTitle: '重啟此工作階段？',
        restartSessionConfirmMessage: '會保留目前執行緒和訊息，只停止本機上的工作階段程序，然後在同一台裝置上重新啟動。',
        restartSessionConfirmAction: '重啟',
    ...
    codex: {
        ...
        sync: {
            accessibilityLabel: '同步最新 Codex 工作階段',
            title: '同步 Codex 工作階段',
            manual: '手動',
            subtitle: '匯入此裝置最近的本機 Codex.app 執行緒中繼資料。',
            footer: '僅同步最近未封存執行緒',
            syncing: '同步中',
            ready: '就緒',
            offline: '離線',
