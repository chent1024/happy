...
export const zhHans: TranslationStructure = {
    ...
    status: {
        ...
        recentlyActive: ({ time }: { time: string }) => `最近活跃 ${time}`,
    ...
    sessionInfo: {
        ...
        resumeSessionNeedsHappyAgent: '此设备暂不支持恢复。请运行 `happy-agent auth login` 启用。',
        resumeSessionMissingMachine: '此会话缺少设备元数据，无法恢复。',
        resumeSessionMissingBackendId: '此会话没有可恢复的 Claude 或 Codex 标识。',
        resumeSessionUnexpectedDirectoryPrompt: '恢复流程不能创建目录。请从原始路径手动启动会话。',
        restartSession: '重启会话',
        restartSessionConfirmTitle: '重启此会话？',
        restartSessionConfirmMessage: '会保留当前线程和消息，只停止本机上的会话进程，然后在同一台设备上重新启动。',
        restartSessionConfirmAction: '重启',
    ...
    codex: {
        ...
        sync: {
            accessibilityLabel: '同步最新 Codex 会话',
            title: '同步 Codex 会话',
            manual: '手动',
            subtitle: '导入此设备最近的本地 Codex.app 线程元数据。',
            footer: '仅同步最近未归档线程',
            syncing: '同步中',
            ready: '就绪',
            offline: '离线',
