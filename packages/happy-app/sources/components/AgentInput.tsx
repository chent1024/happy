...
const stylesheet = StyleSheet.create((theme, runtime) => ({
    ...
    unifiedPanel: {
        backgroundColor: Platform.select({ web: theme.colors.input.background, default: theme.colors.surface }),
        borderRadius: Platform.select({ web: 16, default: 32 }),
        borderWidth: Platform.select({ web: 0, default: StyleSheet.hairlineWidth }),
        borderColor: Platform.select({ web: 'transparent', default: theme.colors.divider }),
        overflow: 'hidden',
        paddingVertical: Platform.select({ web: 2, default: 4 }),
        paddingBottom: Platform.select({ web: 8, default: 6 }),
        paddingHorizontal: Platform.select({ web: 8, default: 10 }),
        shadowColor: Platform.select({ web: 'transparent', default: theme.colors.shadow.color }),
        shadowOffset: Platform.select({ web: { width: 0, height: 0 }, default: { width: 0, height: 6 } }),
        shadowOpacity: Platform.select({ web: 0, default: theme.dark ? 0.28 : 0.14 }),
        shadowRadius: Platform.select({ web: 0, default: 16 }),
        elevation: Platform.select({ web: 0, default: 8 }),
    },
    inputContainer: {
        flexDirection: 'row',
        alignItems: 'center',
        borderWidth: 0,
        paddingLeft: Platform.select({ web: 8, default: 10 }),
        paddingRight: Platform.select({ web: 8, default: 6 }),
        paddingVertical: Platform.select({ web: 4, default: 0 }),
        minHeight: Platform.select({ web: 40, default: 42 }),
    },
    ...
    actionButtonsContainer: {
        ...
        justifyContent: 'space-between',
        paddingHorizontal: 0,
        minHeight: Platform.select({ web: undefined, default: 44 }),
    },
    actionButtonsLeft: {
        flexDirection: 'row',
        gap: 8,
    ...
    actionButton: {
        ...
        paddingVertical: 6,
        justifyContent: 'center',
        height: Platform.select({ web: 32, default: 38 }),
    },
    actionButtonPressed: {
        opacity: 0.7,
    },
